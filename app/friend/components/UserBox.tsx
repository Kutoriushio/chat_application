        ...
        <div className="w-full relative gap-3 flex items-center p-2 bg-white  rounded-lg transition hover:bg-sky-200 hover:bg-opacity-70">
          ...
          {request ? (
            <div className="flex gap-x-4 p-2 items-center justify-center">
              <RxCross1 className="cursor-pointer rounded-full w-7 h-7 p-1 hover:bg-sky-200 text-red-500" />
              <GrCheckmark className="cursor-pointer rounded-full w-7 h-7 p-1 hover:bg-sky-200 text-green-500" />
            </div>
          ) : (
            <div className="flex gap-x-4 p-2 items-center justify-center">
    ...
    <>
      ...
      <div className="w-[calc(50%-12px)] 2xl:w-[calc(25%-18px)] xl:w-[calc(33.33%-16px)] h-32 bg-[#fefefe] p-5 rounded-2xl relative">
        ...
        <div className="absolute right-4 bottom-1">
          {request ? (
            <div className="flex gap-x-4 p-2 items-center justify-center">
              <RxCross1 className="cursor-pointer rounded-lg w-6 h-6 p-1 hover:bg-gray-100 text-red-500 ring-1 ring-inset ring-red-500" />
              <GrCheckmark className="cursor-pointer rounded-lg w-6 h-6 p-1 hover:bg-gray-100 text-green-500 ring-1 ring-inset ring-green-500" />
            </div>
          ) : (
            <div className="flex gap-x-4 p-2 items-center justify-center">
              <HiOutlineChatBubbleLeftEllipsis
